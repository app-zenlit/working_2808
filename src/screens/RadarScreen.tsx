...
import { MapPinIcon, ExclamationTriangleIcon, ArrowPathIcon, ChevronLeftIcon, PlusIcon, ChatBubbleLeftIcon, EyeIcon, EyeSlashIcon } from '@heroicons/react/24/outline';
    ...
    <div className="min-h-full bg-black">
      ...
      <div className="sticky top-0 z-10 bg-black/90 backdrop-blur-sm border-b border-gray-800">
        <div className="px-4 py-4">
          ...
          {/* Refresh Button - Centered below toggle */}
      ...
      <div className="px-4 py-4 space-y-4 pb-20 overflow-y-auto">
        {isLocationEnabled ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Turn on the eye toggle to see people around you
            </p>
            <button
              onClick={() => handleLocationToggle(true)}
              disabled={isTogglingLocation}
